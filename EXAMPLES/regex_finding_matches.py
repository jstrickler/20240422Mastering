...
ea commodo z-883  consequat. Duis x-1 aute irure dolor in reprehenderit in
...
m = re.search(pattern, s)  # search actually returns match object or None
print(m)
if m:
    print("Found:", m.group(0), m.span(0))  # group(0) returns text that was matched by entire expression (or just m.group())
print()
